...
function insertarDatos(tabla) {
    ...
    if (tabla === "cliente") {
        ...
        bodyData = `id_cliente=${id_cliente}&id_sucursal=${id_sucursal}&nombre_cli=${nombre_cli}&apellido_cli=${apellido_cli}&cedula=${cedula}&correo=${correo}`;
    } 
        ...
        bodyData = `id_empleado=${id_empleado}&id_sucursal=${id_sucursal}&nombre=${nombre}&direccion=${direccion}&telefono=${telefono}`;
    } 
        ...
        bodyData = `id_pedido=${id_pedido}&id_sucursal=${id_sucursal}&id_cliente=${id_cliente}&id_empleado=${id_empleado}&id_producto=${id_producto}&num_pedido=${num_pedido}&fecha_pedido=${fecha_pedido}&cantidad=${cantidad}`;
    } 
